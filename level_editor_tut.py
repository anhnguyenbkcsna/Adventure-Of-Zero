...
#create buttons
save_button = button_level_editor.Button(SCREEN_WIDTH // 2, SCREEN_HEIGHT + LOWER_MARGIN - 50, save_img, 1)
load_button = button_level_editor.Button(SCREEN_WIDTH // 2 + 200, SCREEN_HEIGHT + LOWER_MARGIN - 50, load_img, 1)
#make a button_level_editor list
button_list = []
button_col = 0
button_row = 0
for i in range(len(img_list)):
	tile_button = button_level_editor.Button(SCREEN_WIDTH + (75 * button_col) + 50, 75 * button_row + 50, img_list[i], 1)
